...
jQuery(document).ready(function(){
	...
	jQuery('body').on('click', ".dashicons-media-document",function(){
		...
		jQuery('.print_table').before('<h2 style="color:#000000;margin-top:1em;border-bottom:2px solid #000000;">Association Sportive de Tires de Tracteurs du Québec</h2><br />');
...
function saveCompetition(eventSender){
	...
	jQuery('#page-container').addClass('loading');
